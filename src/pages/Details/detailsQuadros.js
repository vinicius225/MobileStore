 ...
 return (
   <ScrollView style={styles.container}>
       ...
       <View>
         ...
         <Button style={{backgroundColor:"black"}}  onPress={() => Linking.openURL('mailto:support@example.com?subject=Comprar_ALgo&body=Description') }
      title="Comprar" />
